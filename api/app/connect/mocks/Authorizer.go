...
func (_m *Authorizer) AuthorizationByCommonToken(ctx context.Context, tokenType string, token string) (*authorization.Authorization, error) {
...
func (_m *Authorizer) ImplicitAuthorization(ctx context.Context, userID uuid.UUID, clientID string, scopes string) (*authorization.Authorization, error) {
...
func (_m *Authorizer) VerifyUserAuthorization(ctx context.Context, userID uuid.UUID, clientID string) (*authorization.Authorization, error) {
