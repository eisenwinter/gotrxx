...
// PreRotationChallenge provides a mock function with given fields: ctx, authorizationCode, codeVerifier
func (_m *TokenRotator) PreRotationChallenge(ctx context.Context, authorizationCode string, codeVerifier string) error {
	ret := _m.Called(ctx, authorizationCode, codeVerifier)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, authorizationCode, codeVerifier)
	} else {
		r0 = ret.Error(0)
	}
...
// RevokeCommonTokensForAuthorization provides a mock function with given fields: ctx, autID
func (_m *TokenRotator) RevokeCommonTokensForAuthorization(ctx context.Context, autID uuid.UUID) error {
	ret := _m.Called(ctx, autID)
